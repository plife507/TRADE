...
Window size: 20
Total operations: 100,000 × 2 × 20 = 4,000,000 comparisons
```

For larger windows (`n=200` for daily structure):
```
Total operations: 100,000 × 2 × 200 = 40,000,000 comparisons
```
...
- Memory overhead: 8 bytes × bars × windows
