...
| `configs/plays/_validation/V_050_zone_enhanced.yml` | 1 |
| `configs/plays/_validation/V_051_market_structure.yml` | 2 |
| `configs/plays/_validation/V_052_bos_entry.yml` | 2 |
| `configs/plays/_validation/V_053_choch_reversal.yml` | 2 |
| `configs/plays/_validation/V_054_order_block_bullish.yml` | 3 |
| `configs/plays/_validation/V_055_order_block_bearish.yml` | 3 |
| `configs/plays/_validation/V_056_breaker_block.yml` | 3 |
| `configs/plays/_validation/V_057_fvg_bullish.yml` | 4 |
| `configs/plays/_validation/V_058_fvg_bearish.yml` | 4 |
| `configs/plays/_validation/V_059_fvg_ce_entry.yml` | 4 |
| `configs/plays/_validation/V_060_liquidity_bsl.yml` | 5 |
| `configs/plays/_validation/V_061_liquidity_ssl.yml` | 5 |
| `configs/plays/_validation/V_062_liquidity_sweep.yml` | 5 |
| `configs/plays/_validation/V_063_ict_ob_fvg_combo.yml` | 6 |
| `configs/plays/_validation/V_064_ict_bos_ob.yml` | 6 |
| `configs/plays/_validation/V_065_ict_choch_fvg.yml` | 6 |
| `configs/plays/_validation/V_066_ict_liquidity_sweep.yml` | 6 |
| `configs/plays/_validation/V_067_ict_premium_discount.yml` | 6 |
| `configs/plays/_stress_test/T_010_ict_full_model.yml` | 6 |
...
1. **Normalize**: `python trade_cli.py backtest play-normalize-batch --dir configs/plays/_validation`
