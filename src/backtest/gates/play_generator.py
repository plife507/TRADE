...
class GeneratorConfig:
    ...
    output_dir: Path = field(default_factory=lambda: Path("plays/validation/_generated"))
...
def cleanup_generated_plays(output_dir: Path = Path("plays/validation/_generated")) -> None:
