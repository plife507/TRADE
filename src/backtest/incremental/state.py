...
class MultiTFIncrementalState:
    ...
    Manages an exec (execution) timeframe state plus optional high_tf (higher
    ...
    def update_high_tf(self, timeframe: str, bar: "BarData") -> None:
        ...
        if timeframe not in self.high_tf:
            ...
            raise KeyError(
                f"high_tf '{timeframe}' not configured.\n"
                f"\n"
    ...
    def get_value(self, path: str) -> float | int | str:
        ...
        Examples:
            ...
            - "high_tf_1h.trend.direction" - Trend direction from 1h TF
            - "high_tf_4h.fib.level_0.618" - Fib level from 4h TF
        ...
        if tf_role == "exec":
            ...
            if tf_name not in self.high_tf:
                ...
                raise KeyError(
                    f"high_tf '{tf_name}' not configured.\n"
                    f"\n"
                    f"Available high_tfs: {available_str}\n"
                    f"\n"
